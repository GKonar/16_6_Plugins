...
var App = function (_React$Component) {
	...
	function App(props) {
		...
		_this.removeTodo = _this.removeTodo.bind(_this); // do zachowania kontekstu
		_this.state = {
			data: [{
				id: 1,
				text: 'clean room'
		...
		value: function render() {
			return (// użycie pierwszego loadera CSS
				_react2.default.createElement(
					...
					_react2.default.createElement(_Title2.default, { title: 'ToDo list App', tasks: 'Things to do' }),
					_react2.default.createElement(_TodoList2.default, { list: this.state.data, removeLi: this.removeTodo })
				)
			);
		}
	}]);
...
// imports
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Lato:400,700&subset=latin-ext);", ""]);
...
var Title = function Title(props) {
	return (//props zawsze dostajemy od parenta
		_react2.default.createElement(
			'div',
			null,
			_react2.default.createElement(
...
var TodoList = function TodoList(props) {
	var listItems = props.list.map(function (element) {
		return _react2.default.createElement(
			'li',
			{ className: _TodoList2.default.liLook, key: element.id, onClick: function onClick() {
					return props.removeLi(element.id);
				} },
			element.text
		);
	});
	return _react2.default.createElement(
		'ul',
		{ className: _TodoList2.default.TodoLook },
		listItems
	);
};
...
// module
exports.push([module.i, "._1GkdMMH5sNUUY8iyEfs9-y {\n\tbackground-color: #38ada9;\n\tlist-style-type: none;\n\tfont-size: 25px;\n\tdisplay: flex;\n    flex-direction: column;\n    flex-wrap: nowrap;\n    justify-content: center;\n    align-items: center;\n    align-content: center;\n    padding: 15px;\n    text-align: center;\n    border-radius: 5px;\n    box-shadow: 10px 10px 20px 0px rgba(0,0,0,0.75);\n    font-family: 'Lato', sans-serif;\n}\n\n._3Ft9wXF8d1qv9o64ZAodaN {\n\tcursor: pointer;\n}\n\n._3Ft9wXF8d1qv9o64ZAodaN:hover {\n\ttext-decoration: underline;\n}", ""]);

// exports
exports.locals = {
	"TodoLook": "_1GkdMMH5sNUUY8iyEfs9-y",
	"liLook": "_3Ft9wXF8d1qv9o64ZAodaN"
};
